 ...
 * Use the {@link UpdateSportFragment#newInstance} factory method to
...
public class UpdateSportFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        update = view.findViewById(R.id.button_sport_update);
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.myDatabase.Daotemp().updateSport(sportPin);
        ...
        back = view.findViewById(R.id.backUpSport);
