...
public class TeamInsertFragment extends Fragment {
     ...
     * @return A new instance of fragment TeamInsertFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        insert = view.findViewById(R.id.button_team_insert);
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.myDatabase.Daotemp().insertTeam(teamPin);
        ...
        back = view.findViewById(R.id.backTeam);
